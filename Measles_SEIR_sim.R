...
disease.state                 =       reduce.susceptibles (6, 20, disease.state, 0.85, num.comps, susceptible.indices)
disease.state                 =       reduce.susceptibles (21, max(demographic.ages[, 1]), disease.state, 0.85, num.comps, susceptible.indices)
