...
source("SIR_measles.R")

disease.state                 <-      initial.disease.state (demographic.ages  ,  v  , 1 ,  num.comps)
disease.state                 =       reduce.susceptibles (0, 5, disease.state, 0.95, num.comps, susceptible.indices)
disease.state                 =       reduce.susceptibles (6, 20, disease.state, 0.95, num.comps, susceptible.indices)
